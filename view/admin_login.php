...
<?php
  include '../controller/admin_login_database.php';
?>
<body>
    <div class="center">
        <form class="form_main" action="" method="POST">
            ...
            <div class="inputContainer">
                ...
                <input placeholder="Admin Email" id="email" class="inputField" name="email" type="email">
            </div>
            <p class="err">
                <?php
                echo $emailErr;
            ...
            <div class="inputContainer">
                ...
                <input placeholder="Admin Password" id="password" class="inputField" name="password" type="password">
            </div>
            <p class="err">
                <?php
                echo $emailErr;

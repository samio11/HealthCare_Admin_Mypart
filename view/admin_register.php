...
<?php
include '../controller/admin_register_database.php';
?>
<body>
    <div class="container">
        <form class="form" method="post" enctype="multipart/form-data" onsubmit="return validateAdminRegistration()">
            <span class="title">Admin Registration</span>
            <input type="text" class="input" name="name" id="name" placeholder="username">
            <p id="err1"></p>
            ...
            <p id="err3"></p>
            <span class="sub mb">Choose Admin Picture</span>
            ...
            <p id="err6"></p>
            <span class="sub">Already have an account ? <a href="./admin_login.php">Sign in</a></span>
         <input class="btn" type="submit" value="Register" name="submit">
        </form>
    </div>
   <script src="../controller/js/adminControllAllTask.js"></script>
</body>
